package com.root.sms.api_gateway.utils;
...
public final class CommonUtil {
    ...
    public static HttpCookie getSessionCookie(ServerHttpRequest serverHttpRequest) throws GlobalException {
    ...
    public static HttpCookie getJwtCookie(ServerHttpRequest serverHttpRequest) throws GlobalException {
        MultiValueMap<String, HttpCookie> headers = serverHttpRequest.getCookies();
